...
<body>
    <div class="wrapper">
        ...
        <div class="body">
            <p>{{ __('emails.password_reset_greeting', ['name' => $name]) }}</p>
            <p>{{ __('emails.password_reset_line') }}</p>
            <p style="text-align:center; margin: 28px 0;">
                <a class="btn" href="{{ $url }}">{{ __('emails.password_reset_button') }}</a>
            </p>
            <p style="font-size:12px; color:#666;">{{ __('emails.password_reset_expiry') }}</p>
            <p style="font-size:12px; color:#666;">{{ __('emails.password_reset_ignore') }}</p>
        </div>
