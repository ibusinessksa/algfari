        ...
        <div class="relative mx-auto max-w-7xl px-6 lg:px-8 pt-16 lg:pt-24 pb-20 lg:pb-28 grid lg:grid-cols-12 gap-12 items-center">
            <div class="lg:col-span-7">
                ...
                <div class="mt-8 flex flex-wrap items-center gap-3">
                    <a href="{{ config('app.play_store_url') ?: '#download' }}" class="inline-flex items-center gap-2 h-12 px-6 rounded-xl bg-brand-700 hover:bg-brand-800 text-white font-semibold shadow-lg shadow-brand-900/20 transition">
            ...
            <div class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-brand-700 via-brand-800 to-ink-900 text-white px-8 sm:px-16 py-16 lg:py-20">
                ...
                <div class="relative grid lg:grid-cols-2 gap-10 items-center">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 lg:justify-end">
                        <a href="{{ config('app.app_store_url') }}" class="inline-flex items-center gap-3 h-14 px-6 rounded-2xl bg-white text-ink-900 hover:bg-brand-50 transition font-semibold">
                        ...
                        <a href="{{ config('app.play_store_url') }}" class="inline-flex items-center gap-3 h-14 px-6 rounded-2xl bg-white text-ink-900 hover:bg-brand-50 transition font-semibold">
