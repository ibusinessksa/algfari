...
return [
    ...
    'title' => 'Family Tribe App API Documentation',
    ...
    'auth' => [
        ...
        'extra_info' => 'Authenticate via the <b>POST /api/v1/auth/login</b> endpoint to receive a Bearer token. Include it in the <code>Authorization</code> header as <code>Bearer {token}</code>.',
    ],
